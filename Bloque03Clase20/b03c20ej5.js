...
const itero = numeros.values();

console.log(itero.next().value);
console.log(itero.next().value);
console.log(itero.next().value);
console.log(itero.next().value);
console.log(itero.next().value);
